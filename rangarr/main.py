...
def _run_search_cycle(active_clients: list[Any], settings: dict) -> None:
    ...
    missing_pools: dict[Any, list[MediaItem]] = {}
    upgrade_pools: dict[Any, list[MediaItem]] = {}

    for client in active_clients:
        candidates = client.get_media_to_search(global_missing, global_upgrade)

        m_items = [cnd for cnd in candidates if cnd[1] == 'missing']
        u_items = [cnd for cnd in candidates if cnd[1] == 'upgrade']
