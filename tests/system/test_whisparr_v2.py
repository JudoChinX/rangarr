"""System tests for WhisparrV2Client end-to-end flow using realistic HTTP fixtures."""
...
from tests.system.helpers import _make_whisparr_v2_router


def test_full_search_cycle_with_whisparr_v2(caplog: pytest.LogCaptureFixture) -> None:
    """Test a full search cycle with a real WhisparrV2Client and fixture HTTP responses."""
    config = {
        'instances': {
            'whisparr_v2': [
                {
    ...
    router = _make_whisparr_v2_router(
