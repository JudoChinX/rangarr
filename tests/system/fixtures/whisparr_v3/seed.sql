...
INSERT OR REPLACE INTO MovieMetadata (Id, ForeignId, MetadataSource, Images, Title, SortTitle, CleanTitle, OriginalLanguage, Status, Runtime, ReleaseDate, Year, Ratings, Genres, Recommendations, ItemType, StudioTitle)
VALUES
